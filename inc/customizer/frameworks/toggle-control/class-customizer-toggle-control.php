...
class Customizer_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-toggle-control', get_stylesheet_directory_uri() . '/inc/customizer/frameworks/toggle-control/js/customizer-toggle-control.js', array( 'jquery' ), rand(), true );
		wp_enqueue_style( 'pure-css-toggle-buttons', get_stylesheet_directory_uri() . '/inc/customizer/frameworks/toggle-control/pure-css-toggle-buttons/pure-css-togle-buttons.css', array(), rand() );
